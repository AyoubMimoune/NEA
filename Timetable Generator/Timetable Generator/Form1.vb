...
Public Class Form1
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        If (pword = pass) Then 'Checks if the password fetched is the same that has been entered into the form
            ...
            If System.IO.File.Exists("C:\Users\" + TextBox6.Text + "\Documents\timetable.png") Then 'Checking if a timetable exists
                ...
                ElseIf result = MsgBoxResult.No Then 'However if the user does not want to create timetable
                    Process.Start("C:\Users\" + TextBox6.Text + "\Documents\timetable.png") 'Their current timetable will be displayed
                    Me.Close() 'Hides the current form
                End If
            ElseIf (pword = pass) Then 'If the user currently does not have a timetable then they will be directed to the next form
                Form2.Show()
                Me.Hide()
            End If
